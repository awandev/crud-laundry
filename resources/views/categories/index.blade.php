{{-- mengambil master template yang sudah dibuat, yakni admin.blade.php --}}
                        ...
                        <div class="card-body">
                            <form action="{{ route('category.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- variabel $parent pada method index kita gunakan disini --}}
                                    {{-- untuk menampilkan data category yang parent idnya NULL --}}
